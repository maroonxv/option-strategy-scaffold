...
- [x] 8. 实现 AutoSaveService
  ...
  - [x] 8.2 编写 AutoSaveService 属性测试
    - **Property 1: Auto-save interval gating**
    - **Validates: Requirements 1.1, 1.3**
  - [x] 8.3 编写 AutoSaveService 单元测试
    - 测试默认间隔 60 秒、写入失败不中断
